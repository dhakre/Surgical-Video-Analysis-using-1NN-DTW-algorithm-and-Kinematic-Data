...
public class Histogram {
    ...
    private BufferedImage getImage() {
        try {
            return ImageIO.read(new File( "C:/Users/user/Documents/Java gesture recognistion/Images/frame2.png"));
        } catch (IOException e) {
    ...
    private void display() {
       ...
       // f.add(new JLabel(new ImageIcon(image)), BorderLayout.WEST); //to show image along with the pannel of the histogram
        ...
        try{
            ...
            f.paint(graphics2D);
            ImageIO.write(image,"jpeg", new File("C:/Users/user/Documents/Java gesture recognistion/HistogramsAndCharts/HistogramFrame2.jpg"));
